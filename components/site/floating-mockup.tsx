...
export function FloatingMockup() {
  return (
    ...
    >
      <div className="absolute -inset-8 rounded-full bg-blue-500/[.12] blur-3xl" />
      <div className="neuro-glass relative overflow-hidden rounded-[1.75rem] p-2 sm:p-3">
        <div className="rounded-[1.3rem] border border-white/10 bg-[#030307]/95 p-4 sm:p-5">
          {/* Header */}
              ...
              {[65, 72, 58, 80, 68, 88, 76].map((height, index) => (
                <span
                  ...
                  className={`flex-1 rounded-t-md ${
                    index === 5
                      ? "bg-blue-400"
                      : "bg-gradient-to-t from-blue-950 to-blue-400/80"
                  }`}
                  style={{ height: `${height}%` }}
                />
              ))}
