...
export function StatusBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 h-5 bg-[#030508] border-b border-white/[0.04] font-mono text-[9px] uppercase tracking-[0.12em] text-white/20 flex items-center justify-between px-3">
      ...
      <div className="flex items-center gap-3">
        <span className="text-white/10">IST</span>
