          ...
          <div className="grid gap-10 pb-12 lg:grid-cols-[1.35fr_0.7fr_0.8fr_0.9fr]">
            <div className="max-w-sm">
              ...
              <p className="mt-4 text-sm leading-7 text-white/45">
                AI engineering studio building custom automation systems, premium websites, and digital products for healthcare.
              </p>
              <p className="mt-5 text-xs font-medium uppercase tracking-[0.28em] text-white/40">Engineer. Build. Scale.</p>
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.26em] text-white/30">Explore</p>
              <div className="mt-4 space-y-2.5">
                {[["Services","/solutions"],["Projects","/portfolio"],["About","/about"],["Contact","/contact"]].map(([l,h])=>(
                  <Link key={l} className="block text-sm text-white/45 transition hover:text-white" href={h}>{l}</Link>
                ))}
              </div>
            </div>
            <div>
              ...
              <address className="not-italic mt-4 space-y-2 text-sm text-white/45">
                ...
                <a className="block transition hover:text-white" href="mailto:nexeusnovastudio@gmail.com">nexeusnovastudio@gmail.com</a>
              </address>
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.26em] text-white/30">Start a project</p>
              <p className="mt-4 text-sm leading-7 text-white/45">Ready to build? Let&apos;s talk.</p>
              <Link className="inline-flex text-sm text-white/60 underline underline-offset-4 transition hover:text-white" href="/contact">Book a Call</Link>
            </div>
          </div>
