    ...
    <div className="content-fade">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-4">
        {[
          ...
          <div className="glass rounded-3xl p-6" key={n as string}>
            <p className="text-white/50">{n}</p>
            <p className="mt-3 text-4xl font-semibold">{v}</p>
          </div>
        ))}
      </div>
      <p className="mt-8 text-white/55">
        Use the left menu to manage leads, blog posts, portfolio projects,
